...
export class InMemoryDataService implements InMemoryDbService{
  createDb(): {} {
    const offerings = [
      ...
      {
        id: 20,
        name: 'Business tooling',
        ref: 'business-tools',
        type: 'network',
        index: 1,
        url: 'business-tooling',
        avatar: '',
        img: '',
        summary: '',
        children: [],
        composition: {
          ...
          tags: [ 'Microsoft 365', 'Serverless servers'],
          description: '',
          heading: '',
          subheading: '',
          synopsis: ''
  ...
  genId(offerings: Offering[]): number{
    return offerings.length > 0 ? Math.max(...offerings.map(offering => offering.id)) + 1 : 11;
  }
